    ...
    const loadInitialProducts = async () => {
      ...
      try {
        ...
        if (loadedProducts.length === 0) {
          setProductsError(
            "Keine Produkte verfügbar. Bitte Internetverbindung prüfen.",
          );
        }
      } catch (err) {
...
`,
  ...
  return (
    <div className="flex flex-col min-h-screen sm:max-h-screen bg-gray-100 w-full">
      ...
      <main className="flex flex-col sm:flex-row flex-1 h-full p-4 gap-4 overflow-y-hidden">
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center p-4">
                  ...
                  <p className="text-gray-500 text-sm">
                    Die App funktioniert offline, falls bereits Produkte
        ...
        <div className="w-full sm:w-1/3 flex flex-col gap-4">
          <div className="bg-white rounded-lg shadow-md p-4 flex-1">
            <div className="flex justify-between items-center mb-4">
              ...
              {selectedProducts.length > 0 && (
                <button
                  className="m-0 underline text-red-500 text-sm"
          ...
          <TotalDisplay
            selectedProducts={selectedProducts}
            onCompleteSale={handleOpenCheckoutModal}
          />
        </div>
      </main>
      <CheckoutModal
