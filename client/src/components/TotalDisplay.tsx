  ...
  return (
    <div className="bg-blue-600 text-white rounded-lg shadow-md p-4">
      ...
      <button
        ...
        className={`w-full py-3 px-4 rounded-md mt-4 font-medium transition-colors ${itemCount === 0 ? "bg-gray-400 text-gray-200 cursor-not-allowed" : "bg-green-500 hover:bg-green-600 text-white"}`}
      >
        Kauf abschliessen
      </button>
    </div>
