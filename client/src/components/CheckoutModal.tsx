        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="mb-4">
              ...
              <span className="font-bold">{total.toFixed(2)} Fr.</span>{" "}
              abzuschliessen.
            </p>
            <p className="text-gray-600">
              Bitte wählen Sie unten Ihre bevorzugte Zahlungsmethode aus. Wenn
              Sie eine Quittung erhalten möchten, geben Sie bitte Ihre
              E-Mail-Adresse ein.
            </p>
          </div>
          <div className="mb-6">
                ...
                <div className="flex items-center h-0 -ml-1">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      <radialGradient
                        id="paint1_radial_1_801"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(9.54728 13.59) scale(11.6671 11.6671)"
                      >
                      ...
                      <clipPath id="clip0_1_801">
                        <rect
                          ...
                          height="26.6544"
                          fill="white"
                          transform="translate(6.32001 4.17282)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
